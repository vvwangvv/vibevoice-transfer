...
class VibeVoiceTextTokenizer(Qwen2Tokenizer):
    ...
    def _add_vibevoice_special_tokens(self):
        ...
        special_tokens = {
            "additional_special_tokens": [
                ...
                "<|box_start|>",  # Text start (resuing box tokens)
                "<|box_end|>",  # Text end
            ]
        }
        ...
        self._text_start_id = self.convert_tokens_to_ids("<|box_start|>")
        self._text_end_id = self.convert_tokens_to_ids("<|box_end|>")
    ...
    @property
    def text_start_id(self) -> int:
        return self._text_start_id

    @property
    def text_end_id(self) -> int:
        return self._text_end_id
...
class VibeVoiceTextTokenizerFast(Qwen2TokenizerFast):
    ...
    @property
    def text_start_id(self) -> int:
        """Id of the text start token."""
        return self._text_start_id

    @property
    def text_end_id(self) -> int:
        """Id of the text end token."""
        return self._text_end_id
