...
class VibeVoiceForConditionalGenerationInference(VibeVoicePreTrainedModel, GenerationMixin):
    ...
    def generate(
        ...
        **kwargs,
        ...
        for step in progress_bar:
            ...
            if is_prefill and speech_tensors is not None:
            ...
            next_inputs_embeds = self.model.get_input_embeddings()(next_tokens).unsqueeze(
                1
    ...
    def sample_speech_tokens(self, condition, neg_condition, cfg_scale=3.0):
        ...
        # speech = torch.randn(condition.shape[0], self.config.semantic_vae_dim).to(condition)
